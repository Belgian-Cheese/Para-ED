...
*    `#MainMenu {visibility: hidden !important;}` hides the three bars in the top left
* `[data-testid="stAppViewContainer"] > div:last-child { display: none !important; }` hies the specific "Hosted by Streamlit"
*`[data-testid="stDecoration"] { display:none !important }` hids the the red colored rectangle and icon beside it using display because visiblity seems to create an empty rectangle
 *   `.css-10trblm{ display:none !important;}`  Targets the div containing your username for the 'Created By...'
*    `footer { visibility: hidden !important;}` Hides any remaining part that had a footer style tag
*     `.css-q8s9bb{ display:none !important;}` Removes the extra underline below the GitHub username link.
*   ` [data-testid="stFooter"] {visibility:hidden !important} ` Hides anything if the attribute is still available in the page.

*  `.css-1y4p8pa {display: none !important;} and   .css-h484o3 { display: none !important;}` Target and delete two more streamlit tag, just to be extra safe. These seem to have the streamlit branding

  *     `.css-vurnku {display:none !important;} `  Target a canvas object where it also loads an object

*  ` [aria-label="streamlit_menu"]{display:none !important}`  targets a div section containing a dropdown arrow in the corner of the page if there's still one.
    ...
    #MainMenu {visibility: hidden !important;}
     ...
     .css-10trblm{ display:none !important;}
      footer { visibility: hidden !important;}
        .css-q8s9bb{ display:none !important}
         [data-testid="stFooter"] {visibility:hidden !important}
          .css-1y4p8pa {display: none !important;
     }

 .css-h484o3 { display: none !important;
 }
    .css-vurnku {
       display: none !important;
    }
         [aria-label="streamlit_menu"]{display:none !important}
